...
#SBATCH --job-name=AffinityCalc_BOX
...
python3 main.py --outRootName /root_files/May24_all_events.root --plotName BOX_single_pion_all_events.pdf --xlsxFileName xlsx/May24_all_events --fileFromLundAnalysis Files_Spring_24/May_24/file_0_all_events.root --useDriver False --useArgs True 